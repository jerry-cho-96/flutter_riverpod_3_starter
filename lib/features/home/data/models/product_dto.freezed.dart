...
@override
String toString() {
  return 'ProductDto(id: $id, title: $title, description: $description, category: $category, price: $price, rating: $rating, stock: $stock, brand: $brand, thumbnail: $thumbnail)';
}
...
class _ProductDto implements ProductDto {
  const _ProductDto({required this.id, required this.title, required this.description, required this.category, required this.price, required this.rating, required this.stock, this.brand, this.thumbnail});
